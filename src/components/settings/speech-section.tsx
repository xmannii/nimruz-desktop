      ...
      >
        <div className="grid grid-cols-1 gap-4 xl:grid-cols-2 items-stretch">
          {SHENAVA_MODEL_KEYS.map((modelKey) => {
            ...
            return (
                <Card key={modelKey} className="flex h-full flex-col">
                  <CardHeader className="flex min-h-35 flex-col gap-4 pb-4">
                    <div className="flex items-center justify-between gap-3 w-full">
                      <CardTitle className="text-lg leading-none whitespace-nowrap">
