    ...
    <div className="flex flex-col gap-10">
      ...
      >
        <Alert>
          ...
          <AlertDescription>
            ربات فقط گفت‌وگوی خصوصی حساب جفت‌شده را می‌پذیرد. خواندن‌های امن
            می‌توانند مستقیم اجرا شوند؛ نوشتن فایل، فرمان ترمینال، شبکه و
            عملیات حساس حتی اگر در دسکتاپ مجاز شده باشند، در تلگرام دوباره
            تأیید می‌خواهند. پیام‌های صوتی پس از دریافت از تلگرام، با مدل نصب‌شده
            شنوا روی همین دستگاه رونویسی می‌شوند و متن آن‌ها به ایجنت می‌رسد.
            پاسخ‌های مدل با قالب‌بندی تلگرام (پررنگ، کد، لینک و…) نمایش داده
            می‌شوند. بستن پنجره مشکلی ندارد، اما خود نیمروز و کامپیوتر باید روشن و
            آنلاین بمانند.
          </AlertDescription>
        </Alert>
      </SettingsSection>
