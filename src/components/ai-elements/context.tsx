    ...
    <HoverCardTrigger closeDelay={0} delay={0}>
      {children ?? (
        <Button type="button" variant="ghost" {...props}>
          <ContextIcon />
          <span className="font-semibold">{renderedPercent}</span>
        </Button>
      )}
    </HoverCardTrigger>
  );
...
export const ContextReasoningUsage = ({
  ...
  return (
    <div
      ...
      {...props}
    >
      <span className="text-muted-foreground">استدلال</span>
...
export const ContextCacheUsage = ({
  ...
  return (
    <div
      ...
      {...props}
    >
      <span className="text-muted-foreground">کش</span>
