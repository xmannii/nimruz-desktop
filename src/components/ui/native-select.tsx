  ...
  return (
    ...
    >
      <select
        ...
        {...props}
      />
      <ChevronDownIcon className="pointer-events-none absolute top-1/2 end-3.5 size-4 -translate-y-1/2 text-muted-foreground select-none" aria-hidden="true" data-slot="native-select-icon" />
    </div>
  )
}
